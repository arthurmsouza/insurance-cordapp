...
# insurance cordapp CorDapp

This project is the template we will use as a basis for developing a complete CorDapp 
during today's insurance cordapp. Our CorDapp will allow the issuance of tokens onto the ledger.

We'll develop the CorDapp using a test-driven approach. At each stage, you'll know your 
CorDapp is working once it passes both sets of tests defined in `src/test/java/ch.insurance.cordapp`.
...
3. Download the insurance-cordapp repository:

       git clone https://github.com/corda/insurance-cordapp
       
4. Open IntelliJ. From the splash screen, click `Import Project`, select the `insurance cordapp—
...
8. Run the test in `src/test/java/ch.insurance.cordapp/ProjectImportedOKTest.java`. It should pass!
